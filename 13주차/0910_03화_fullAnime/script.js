...
const sec3 = () => {
  ...
  anime({
    ...
    duration: 3000,
    fill: [{ value: "#667eea" }, { value: "#00ffb7" }, { value: "#1dacff" }],
...
s_icons.forEach((li) => {
  li.addEventListener("click", (e) => {
    let target = Number(e.target.datset.index);
    s_reset();
...
const prev = () => {
  let crtSlide = bg.querySelector("sec_slide li.on");
  let i = crtSlide.dataset_index;
  s_reset();
  i--;
